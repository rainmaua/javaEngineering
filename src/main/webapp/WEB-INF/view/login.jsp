		...
		<!-- Nav -->
			<nav id="menu">
				<ul class="links">
					...
					<li><a href="prod/prodList">Product</a></li> 
			...
			<section class="wrapper">
				<div class="inner">
					<header class="special">
						<c:if test="${empty authInfo }">
							<!-- 로그인이 안된 상태 -->
							<p><h3>Sign in to my account</h3>
							<br/>
							<form action="login" method="post">
								
								<div class="form-group">
									<input type="text" class="form-control" name="loginId" placeholder="ID" maxlength="20" /><span>${userFail }</span>
									</br>
								</div>
								<div class="form-group">
									<input type="password" name="loginPw" placeholder="Password" maxlength="20"><span>${pwFail }</span>
									</br>
								</div>
								<input type="submit" class="btn" value="SIGN IN" style="text-algin: center;"  width=100% >
									</br> 
								<div>
									</br>
									아이디/비밀번호 찾기 | 
